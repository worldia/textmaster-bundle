Feature: Translation management
  ...
  Scenario: Generate FR translations for products
    ...
    When I receive the project request '{ "id": "PROJECT-1", "name": "PROJECT-1", "status": "in_progress"}'
    Then I should have the following jobs:
     ...
     When I receive the document request '{ "id": "en-fr-2", "title": "en-fr-2", "status": "in_review", "project_id": "PROJECT-1", "original_content": { "title": { "original_phrase": "Hello NYC"}, "description": { "original_phrase": "NYC is the big apple"}}, "translated_content": { "title": { "translated_phrase": "Bonjour NYC"}, "description": { "translated_phrase": "NYC est la grosse pomme"}}}'
